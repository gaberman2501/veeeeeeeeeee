...
class ProfileComponentWidget extends StatefulWidget {
  const ProfileComponentWidget({
    super.key,
    this.onEditAction,
    required this.travelagentDoc,
  });

  final Future Function()? onEditAction;
  final TravelagentRecord? travelagentDoc;
...
class _ProfileComponentWidgetState extends State<ProfileComponentWidget> {
  ...
  void initState() {
    ...
    _model.starWorkTextFieldTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.travelagentDoc?.startWork,
      '[not set]',
    ));
                        ...
                        return Stack(
                          children: [
                            ...
                            InkWell(
                                ...
                                await Navigator.push(
                                  ...
                                  PageTransition(
                                    ...
                                    child: FlutterFlowExpandedImageView(
                                      image: Image.network(
                                        widget.travelagentDoc!
                                            .profileBackgroundUrl,
                                        fit: BoxFit.contain,
                                      ),
                                      allowRotation: false,
                                      tag: widget
                                          .travelagentDoc!.profileBackgroundUrl,
                              ...
                              child: Hero(
                                tag:
                                    widget.travelagentDoc!.profileBackgroundUrl,
                        ...
                        onTap: () async {
                          await Future.wait([
                            Future(() async {
                              ...
                              await widget.travelagentDoc!.reference
                                  .update(createTravelagentRecordData(
