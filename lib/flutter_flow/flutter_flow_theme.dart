...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF98FB98);
  late Color tertiary = const Color(0xFF006400);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4CFFA500);
  late Color accent2 = const Color(0x4A98FB98);
  late Color accent3 = const Color(0x4D006400);
  late Color accent4 = const Color(0xCAFFFFFF);
